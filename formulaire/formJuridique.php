...
<form class="formElvantoLike" action="juridique_22.php" name="formulaire" method="post" onSubmit="pasDeuxFois();return valider();">
  ...
  <div class="entree">
    ...
    <div class="entree">
      <h5>Numéro de gsm</h5>
      <input type="text" name="portable" onKeyUp="javascript:VerificationNumero(formulaire.portable)" autocomplete="off" placeholder="" />
    </div>

    <div class="entree">
      <h5>Numéro téléphone fixe</h5>
      <input type="text" name="fixe" onKeyUp="javascript:VerificationNumero(formulaire.fixe)" autocomplete="off" placeholder="" />
    </div>

    <div class="entree">
      <h5>Votre adresse :</h5>
      <input type="text" name="adresse" placeholder="Ex.: 8, rue des Lutins. 1190 Forest" autocomplete="off" required />
      <span class="controle_champ">Ce champ ne peut pas être vide</span>
    </div> <br>
    ...
    <textarea name="motif" placeholder="D&eacute;taillez votre besoin..." autocomplete="off"></textarea><br>

    <div align="center" id="divEnvoyer" style="display:none"><b>
        <font size="3">Veillez patienter... <br />votre demande est en cours de traitement.</font>
      </b></div>
